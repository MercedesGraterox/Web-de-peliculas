...
<div class="row">
 ...
 <div style="padding-top: 40px" class="col-md-12" align="center">
  <div  class="row justify-content-center">
    <form style="background: #212121;padding: 30px;border-radius: 40px" method="POST" action="Eliminar.php">
...
<br>
<button style="width: 40%" id="btn2" type="submit" class="btn btn-secondary" name="eliminar" value="eliminar">Eliminar</button>
</form>
