...
<body style="background-color: #000">
  ...
  <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
    <div class="navbar-nav">
      ...
      <li class="dropdown">
        <a  class="nav-link  dropdown-toggle active" href="" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Categorias</a>
    ...
    <div class="row">
      ...
      if(isset($_GET['genero'])){
         ...
         if(!isset($_GET['pagina'])){
             header("location:categorias.php?genero=$peliculas&pagina=1");
         }
}
          $consulta = mysqli_query($database, "SELECT * FROM peliculas where genero='$peliculas'");
          $peliculas_x_pag = 6;
         ...
         ?>
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card" style="width: 17.5rem; height:80%; margin-top:50px;">
  ...
  <div class="col-md-12 ">
    <nav arial-label="page navigation">
      <ul class="pagination justify-content-center" >
        <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>"><a class="page-link" href="categorias.php?pagina=<?php echo $_GET['pagina'] - 1 ?>">Anterior</a></li>
        <?php for ($i = 1; $i <= $paginas; $i++) : ?>
          <li class="page-item <?php echo $_GET['pagina'] == $i ? 'active' : '' ?>"><a class="page-link" href="categorias.php?pagina=<?php echo $i ?>"><?php echo $i ?></a></li>
        <?php endfor ?>
        <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : '' ?>"><a class="page-link" href="categorias.php?pagina=<?php echo $_GET['pagina'] + 1 ?>">Siguiente</a></li>
